...
gi_cloud5_duration init 660 ; Updated from: gi_cloud5_duration init 660
gi_cloud5_fadeout init 30 ; Updated from: gi_cloud5_fadeout init 30
gS_cloud5_soundfile_name init "Droner-1.1.0.wav"
          ...
          connect "Blower", "outleft", "Reverberator", "inleft"
          connect "Blower", "outright", "Reverberator", "inright"
          connect "Bower", "outleft", "Reverberator", "inleft"
          connect "Bower", "outright", "Reverberator", "inright"
          connect "Buzzer", "outleft", "Reverberator", "inleft"
          connect "Buzzer", "outright", "Reverberator", "inright"
          connect "Droner", "outleft", "Reverberator", "inleft"
          connect "Droner", "outright", "Reverberator", "inright"
          connect "FMWaterBell", "outleft", "Reverberator", "inleft"
          connect "FMWaterBell", "outright", "Reverberator", "inright"
          ; Phaser is the one that actually "buzzes" in this piece.
          connect "Phaser", "outleft", "Reverberator", "inleft"
          connect "Phaser", "outright", "Reverberator", "inright"
          connect "Sweeper", "outleft", "Reverberator", "inleft"
          connect "Sweeper", "outright", "Reverberator", "inright"
          connect "Shiner", "outleft", "Reverberator", "inleft"
          connect "Shiner", "outright", "Reverberator", "inright"
          connect "ZakianFlute", "outleft", "Reverberator", "inleft"
          connect "ZakianFlute", "outright", "Reverberator", "inright"
          connect "FilteredSines", "outleft", "Reverberator", "inleft"
          connect "FilteredSines", "outright", "Reverberator", "inright"
          connect "Guitar", "outleft", "Reverberator", "inleft"
          connect "Guitar", "outleft", "Reverberator", "inleft"
          connect "Harpsichord", "outleft", "Reverberator", "inleft"
          connect "Harpsichord", "outright", "Reverberator", "inright"
          connect "Kung2", "outleft", "Reverberator", "inleft"
          connect "Kung2", "outright", "Reverberator", "inright"
          connect "Kung4", "outleft", "Reverberator", "inleft"
          connect "Kung4", "outright", "Reverberator", "inright"
          connect "Plucked", "outleft", "Reverberator", "inleft"
          connect "Plucked", "outright", "Reverberator", "inright"
          connect "SeidelHarmOsc", "outleft", "Reverberator", "inleft"
          connect "SeidelHarmOsc", "outright", "Reverberator", "inright"
          connect "TubularBell", "outleft", "Reverberator", "inleft"
          connect "TubularBell", "outright", "Reverberator", "inright"
          connect "YiString", "outleft", "Reverberator", "inleft"
          connect "YiString", "outright", "Reverberator", "inright"
          connect "VcvOut", "outleft", "Reverberator", "inleft"
          connect "VcvOut", "outright", "Reverberator", "inright"
          connect "Xing", "outleft", "Reverberator", "inleft"
          connect "Xing", "outright", "Reverberator", "inright"
...
gk_Droner_partial1 init 0.154 ; Updated from: gk_Droner_partial1 init .5
gk_Droner_partial2 init 0.055 ; Updated from: gk_Droner_partial2 init .05
gk_Droner_partial3 init 0.154 ; Updated from: gk_Droner_partial3 init .1
gk_Droner_partial4 init 0.483 ; Updated from: gk_Droner_partial4 init .2
gk_Droner_partial5 init 0.101 ; Updated from: gk_Droner_partial5 init .1
gk_Droner_partial6 init 0.108 ; Updated from: gk_Droner_partial6 init .0
gk_Droner_partial7 init 0.41000000000000003 ; Updated from: gk_Droner_partial7 init .0
gk_Droner_partial8 init 0.036000000000000004 ; Updated from: gk_Droner_partial8 init .0
gk_Droner_partial9 init 0 ; Updated from: gk_Droner_partial9 init .0
gk_Droner_partial10 init 0 ; Updated from: gk_Droner_partial10 init .0
gk_Droner_level init 5.50760378133991 ; Updated from: gk_Droner_level init 0
          ...
          a_out_left, a_out_right pan2 a_signal, i_pan
...
gk_FMWaterBell_level init 41.67694204685574 ; Updated from: gk_FMWaterBell_level init 0
...
gk_Phaser_level init -32.63282293700544 ; Updated from: gk_Phaser_level init 0.5
...
gk_Sweeper_britel init 3.193588162762022 ; Updated from: gk_Sweeper_britel init .01
gk_Sweeper_briteh init 0.8261405672009864 ; Updated from: gk_Sweeper_briteh init 5
gk_Sweeper_britels init 3.32511302918208 ; Updated from: gk_Sweeper_britels init .5
gk_Sweeper_britehs init 0.3789560213727908 ; Updated from: gk_Sweeper_britehs init 1.75
gk_Sweeper_level init 45 ; Updated from: gk_Sweeper_level init 0
...
gk_Buzzer_level init -26.71359572500257 ; Updated from: gk_Buzzer_level init 0
...
gk_ZakianFlute_level init -8.298222176549174 ; Updated from: gk_ZakianFlute_level init 0
...
gk_Bower_level init -10.271297913883465 ; Updated from: gk_Bower_level init 0
...
gk_FilteredSines_level init 31 ; Updated from: gk_FilteredSines_level init 0
...
gk_Kung2_level init 3.534730785039045 ; Updated from: gk_Kung2_level init 0
...
gk_Kung4_level init -16.19052512588634 ; Updated from: gk_Kung4_level init 0
...
gk_Plucked_level init 35.10944404480526 ; Updated from: gk_Plucked_level init 0
...
gk_TubularBell_level init -6.982838351659645 ; Updated from: gk_TubularBell_level init 0
...
gk_Reverberator_feedback init 0.9167694204685574 ; Updated from: gk_Reverberator_feedback init 0.875
gk_Reverberator_wet init 0.7768390686173501 ; Updated from: gk_Reverberator_wet init 0.5
gk_Reverberator_delay_modulation init 0.6843403205918619 ; Updated from: gk_Reverberator_delay_modulation init 0.0075
gk_Reverberator_frequency_cutoff init 6100 ; Updated from: gk_Reverberator_frequency_cutoff init 15000

        ;; Allowing swapping original reverb with reverbsc.

        ;; Adapting Sean's original implementation:
        
        instr Reverberator 
        ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ; Authors: Sean Costello and J. Lato
        ; Adapted by Michael Gogins
        ; p4 = gain of reverb in [0, 1]. Adjust empirically
        ...
        ; for the delay lines in [0, 10]. 1 is the "normal"
        ...
        ; in Hz [0, sr /2]. Lower cutoff frequencies results
        ...
        ain1 inleta "inleft"
        ain2 inleta "inright"
        // Sean's reverb assumed mono input; hence collapse the stereo inputs.
        ...
        ; To the master output. The dry signal is the stereo inputs.
...
gk_MasterOutput_level init -44.471845458281955 ; Updated from: gk_MasterOutput_level init -40 ; Updated from: gk_MasterOutput_level init 0
instr MasterOutput
printf "MasterOutput: gi_cloud5_performance_mode: %d gi_cloud5_duration: %f gi_cloud5_fadeout: %f gS_cloud5_soundfile_name: %s\n", 1, gi_cloud5_performance_mode, gi_cloud5_duration, gi_cloud5_fadeout, gS_cloud5_soundfile_name
a_left inleta "inleft"
a_right inleta "inright"
k_gain_linear = ampdb(gk_MasterOutput_level)
k_gain_smoothed portk k_gain_linear, 0.05
a_gain interp k_gain_smoothed
a_left butterlp a_left, 18000
a_right butterlp a_right, 18000
a_envelope linseg 1, gi_cloud5_duration, 1, gi_cloud5_fadeout, 0
a_left = a_left * a_gain * a_envelope
a_right = a_right * a_gain * a_envelope
k_rms_left rms a_left
k_rms_right rms a_right
k_meter_left dbfsamp k_rms_left
k_meter_right dbfsamp k_rms_right
chnset k_meter_left, "gk_MasterOutput_output_level_left"
chnset k_meter_right, "gk_MasterOutput_output_level_right"
; Possible values of gi_cloud5_performance_mode:
...
prints  "%-24s i %9.4f t %9.4f d %9.4f k %9.4f v %9.4f p %9.4f #%3d\n", nstrstr(p1), p1, p2, p3, p4, p5, p7, active(p1)
k_times times 
printks "%-24s i %9.4f t %9.4f d %9.4f k %9.4f v %9.4f p %9.4f #%3d l%9.4f r%9.4f\n", 1, nstrstr(p1), p1, k_times, p3, p4, p5, p7, active(p1), k(a_left), k(a_right)
if gi_cloud5_performance_mode == 2 || gi_cloud5_performance_mode == 4 then
fout gS_cloud5_soundfile_name, 19, a_left, a_right
endif
endin
