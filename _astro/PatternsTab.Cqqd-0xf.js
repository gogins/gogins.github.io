import{j as s}from"./jsx-runtime.CLpGMVip.js";import{c as g,g as C,u as m,d as u,e as p,f as h,h as c,j as f,k as y}from"./util.CA89kRoW.js";import{r as B}from"./index.B9mnsnPE.js";const A=`// Koji Kondo - Swimming (Super Mario World)
stack(
  seq(
    "~",
    "~",
...
`,X=Object.freeze(Object.defineProperty({__proto__:null,amensister:I,arpoon:Q,barryHarris:k,bassFuge:M,belldub:L,blippyRhodes:G,caverave:w,chop:O,csoundDemo:V,delay:K,dinofunk:W,echoPiano:R,festivalOfFingers:S,festivalOfFingers3:Y,flatrave:J,giantSteps:x,goodTimes:_,holyflute:z,juxUndTollerei:$,loungeSponge:Z,meltingsubmarine:q,orbit:H,randomBells:T,sampleDemo:U,sampleDrums:D,sml1:N,swimming:A,undergroundPlumber:j,waa2:P,wavyKalimba:E,zeldasRescue:v},Symbol.toStringTag,{value:"Module"}));Object.fromEntries(Object.entries(X).map(([e,o],a)=>[a,{id:a,code:o,collection:"Stock Examples"}]));function ee(...e){return e.filter(Boolean).join(" ")}function se({pattern:e}){const o=B.useMemo(()=>C(e.code),[e]);let a=o.title;if(a==null){const l=new Date(e.created_at);isNaN(l)?a="unnamed":a=l.toLocaleDateString()}const t=Array.isArray(o.by)?o.by.join(","):"Anonymous";return s.jsx(s.Fragment,{children:`${e.id}: ${a} by ${t.slice(0,100)}`.slice(0,60)})}function ae({showOutline:e,onClick:o,pattern:a,showHiglight:t}){return s.jsx("a",{className:ee("mr-4 hover:opacity-50 cursor-pointer block",e&&"outline outline-1",t&&"bg-selection"),onClick:o,children:s.jsx(se,{pattern:a})})}function oe({patterns:e,activePattern:o,onClick:a,started:t}){const l=p(),d=h(l).id;return s.jsx("div",{className:"",children:Object.values(e).reverse().map(n=>{const b=n.id;return s.jsx(ae,{pattern:n,showHiglight:b===d,showOutline:b===o&&t,onClick:()=>a(b)},b)})})}function i({children:e,onClick:o,label:a,labelIsHidden:t}){return s.jsxs("button",{className:"hover:opacity-50 text-nowrap",onClick:o,title:a,children:[t!==!0&&a,e]})}const r=(e,o,a=!1)=>{e.handleUpdate(o,a)},ne=!g();function te({context:e}){const o=u(),a=p(),t=h(a),{userPatterns:l,patternFilter:F}=m(),d=t?.id;return s.jsxs("div",{className:"flex flex-col gap-2 flex-grow overflow-hidden h-full pb-2 ",children:[s.jsxs("div",{className:"pr-4 space-x-4  flex max-w-full overflow-x-auto",children:[s.jsx(i,{label:"new",onClick:()=>{const{data:n}=c.createAndAddToDB();r(e,n)}}),s.jsx(i,{label:"duplicate",onClick:()=>{const{data:n}=c.duplicate(t);r(e,n)}}),s.jsx(i,{label:"delete",onClick:()=>{const{data:n}=c.delete(d);r(e,{...n,collection:c.collection})}}),s.jsxs("label",{className:"hover:opacity-50 cursor-pointer",children:[s.jsx("input",{style:{display:"none"},type:"file",multiple:!0,accept:"text/plain,text/x-markdown,application/json",onChange:n=>f(n.target.files)}),"import"]}),s.jsx(i,{label:"export",onClick:y}),s.jsx(i,{label:"delete-all",onClick:()=>{const{data:n}=c.clearAll();r(e,n)}})]}),s.jsx("div",{className:"overflow-auto h-full bg-background p-2 rounded-md",children:s.jsx(oe,{onClick:n=>r(e,{...l[n],collection:c.collection},ne),patterns:l,started:e.started,activePattern:o,viewingPatternID:d})})]})}function re({context:e}){return m(),s.jsx("div",{className:"px-4 w-full text-foreground  space-y-2  flex flex-col overflow-hidden max-h-full h-full",children:s.jsx(te,{context:e})})}export{se as P,re as a,ee as c};
