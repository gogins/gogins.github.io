import{j as e}from"./jsx-runtime.DDS51bD4.js";import{u as C,$ as v,c as w,d as f,g as D,e as k,f as B,p as x,h as G,j as E,s as j,k as p,m as r,n as S,o as N}from"./useClient.D23LiVXf.js";import{r as u}from"./index.DIn8BZQ7.js";function _(...s){return s.filter(Boolean).join(" ")}function R({value:s,onChange:t,items:a}){return e.jsx("div",{className:"flex max-w-lg",children:Object.entries(a).map(([n,c],i,h)=>e.jsx("button",{onClick:()=>t(n),className:_("px-2 border-b h-8 whitespace-nowrap",s===n?"border-foreground":"border-transparent"),children:c.toLowerCase()},n))})}const T=`// Koji Kondo - Swimming (Super Mario World)
stack(
  seq(
    "~",
    "~",
...
//# sourceMappingURL=PatternsTab.CoM63fbh.js.map
