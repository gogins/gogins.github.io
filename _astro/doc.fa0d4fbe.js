...
.loopEnd("<1 .75 .5 .25>").scope()`],longname:"loopEnd",kind:"member",scope:"global"},{comment:`/**
   ...
   *
   */`,meta:{filename:"controls.mjs",lineno:383,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{}},description:"<p>choose the channel the pattern is sent to in superdirt</p>",name:"channel",params:[{type:{names:["number","Pattern"]},description:"<p>channel number</p>",name:"channel"}],longname:"channel",kind:"member",scope:"global"},{comment:`/**
   ...
   *
   */`,meta:{filename:"controls.mjs",lineno:401,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{}},description:`<p>Applies the cutoff frequency of the <strong>l</strong>ow-<strong>p</strong>ass <strong>f</strong>ilter.</p>
...
.ftype("<12db 24db>")`],longname:"ftype",kind:"member",scope:"global"},{comment:`/**
   ...
   *
   */`,meta:{filename:"controls.mjs",lineno:637,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{}},description:`<p>Applies the cutoff frequency of the <strong>h</strong>igh-<strong>p</strong>ass <strong>f</strong>ilter.</p>
<p>When using mininotation, you can also optionally add the 'hpq' parameter, separated by ':'.</p>`,name:"hpf",params:[{type:{names:["number","Pattern"]},description:"<p>audible between 0 and 20000</p>",name:"frequency"}],tags:[{originalTitle:"synonyms",title:"synonyms",text:"hp, hcutoff",value:"hp, hcutoff"}],examples:['s("bd sd,hh*4").hpf("<4000 2000 1000 500 200 100>")','s("bd sd,hh*4").hpf("<2000 2000:25>")'],longname:"hpf",kind:"member",scope:"global"},{comment:`/**
   ...
   * note("a")
   * .vib("<.5 1 2 4 8 16>:12")
   */`,meta:{filename:"controls.mjs",lineno:653,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{}},description:"<p>Applies a vibrato to the frequency of the oscillator.</p>",name:"vib",tags:[{originalTitle:"synonyms",title:"synonyms",text:"vibrato, v",value:"vibrato, v"}],params:[{type:{names:["number","Pattern"]},description:"<p>of the vibrato in hertz</p>",name:"frequency"}],examples:[`note("a")
...
.vib("<.5 1 2 4 8 16>:12")`],longname:"vib",kind:"member",scope:"global"},{comment:`/**
   ...
   */`,meta:{filename:"controls.mjs",lineno:668,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{}},description:"<p>Adds pink noise to the mix</p>",name:"noise",params:[{type:{names:["number","Pattern"]},description:"<p>wet amount</p>",name:"wet"}],examples:['sound("<white pink brown>/2")'],longname:"noise",kind:"member",scope:"global"},{comment:`/**
...
.vibmod("<.25 .5 1 2 12>:8")`],longname:"vibmod",kind:"member",scope:"global"},{comment:`/**
   ...
   *
   */`,meta:{filename:"controls.mjs",lineno:728,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{}},description:`<p>Sets the level of the delay signal.</p>
...
separated by ':'.</p>`,name:"delay",params:[{type:{names:["number","Pattern"]},description:"<p>between 0 and 1</p>",name:"level"}],examples:['s("bd").delay("<0 .25 .5 1>")','s("bd bd").delay("0.65:0.25:0.9 0.65:0.125:0.7")'],longname:"delay",kind:"member",scope:"global"},{comment:`/**
   ...
   *
   */`,meta:{filename:"controls.mjs",lineno:744,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{}},description:`<p>Sets the level of the signal that is fed back into the delay.
Caution: Values &gt;= 1 will result in a signal that gets louder and louder! Don't do it</p>`,name:"delayfeedback",params:[{type:{names:["number","Pattern"]},description:"<p>between 0 and 1</p>",name:"feedback"}],tags:[{originalTitle:"synonyms",title:"synonyms",text:"delayfb, dfb",value:"delayfb, dfb"}],examples:['s("bd").delay(.25).delayfeedback("<.25 .5 .75 1>").slow(2)'],longname:"delayfeedback",kind:"member",scope:"global"},{comment:`/**
   ...
   *
   */`,meta:{filename:"controls.mjs",lineno:777,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{}},description:'<p>Set detune of oscillators. Works only with some synths, see <a target="_blank" href="https://tidalcycles.org/docs/patternlib/tutorials/synthesizers">tidal doc</a></p>',name:"detune",params:[{type:{names:["number","Pattern"]},description:"<p>between 0 and 1</p>",name:"amount"}],tags:[{originalTitle:"synonyms",title:"synonyms",text:"det",value:"det"},{originalTitle:"superdirtOnly",title:"superdirtonly",text:""}],examples:[`n("0 3 7").s('superzow').octave(3).detune("<0 .25 .5 1 2>").osc()`],longname:"detune",kind:"member",scope:"global"},{comment:`/**
   ...
   * )
   */`,meta:{filename:"controls.mjs",lineno:908,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{}},description:"<p>An <code>orbit</code> is a global parameter context for patterns. Patterns with the same orbit will share the same global effects.</p>",name:"orbit",params:[{type:{names:["number","Pattern"]},name:"number"}],examples:[`stack(
  s("hh*3").delay(.5).delaytime(.25).orbit(1),
  s("~ sd").delay(.5).delaytime(.125).orbit(2)
   ...
   *
   */`,meta:{filename:"controls.mjs",lineno:978,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{}},description:`<p>Sets the level of reverb.</p>
<p>When using mininotation, you can also optionally add the 'size' parameter, separated by ':'.</p>`,name:"room",params:[{type:{names:["number","Pattern"]},description:"<p>between 0 and 1</p>",name:"level"}],examples:['s("bd sd").room("<0 .2 .4 .6 .8 1>")','s("bd sd").room("<0.9:1 0.9:4>")'],longname:"room",kind:"member",scope:"global"},{comment:`/**
   ...
   */`,meta:{filename:"controls.mjs",lineno:992,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{}},description:`<p>Reverb lowpass starting frequency (in hertz).
When this property is changed, the reverb will be recaculated, so only change this sparsely..</p>`,name:"roomlp",tags:[{originalTitle:"synonyms",title:"synonyms",text:"rlp",value:"rlp"}],params:[{type:{names:["number"]},description:"<p>between 0 and 20000hz</p>",name:"frequency"}],examples:['s("bd sd").room(0.5).rlp(10000)','s("bd sd").room(0.5).rlp(5000)'],longname:"roomlp",kind:"member",scope:"global"},{comment:`/**
   ...
   *
   */`,meta:{filename:"controls.mjs",lineno:1005,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{}},description:`<p>Reverb lowpass frequency at -60dB (in hertz).
When this property is changed, the reverb will be recaculated, so only change this sparsely..</p>`,name:"roomdim",tags:[{originalTitle:"synonyms",title:"synonyms",text:"rdim",value:"rdim"}],params:[{type:{names:["number"]},description:"<p>between 0 and 20000hz</p>",name:"frequency"}],examples:['s("bd sd").room(0.5).rlp(10000).rdim(8000)','s("bd sd").room(0.5).rlp(5000).rdim(400)'],longname:"roomdim",kind:"member",scope:"global"},{comment:`/**
   ...
   *
   */`,meta:{filename:"controls.mjs",lineno:1019,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{}},description:`<p>Reverb fade time (in seconds).
When this property is changed, the reverb will be recaculated, so only change this sparsely..</p>`,name:"roomfade",tags:[{originalTitle:"synonyms",title:"synonyms",text:"rfade",value:"rfade"}],params:[{type:{names:["number"]},description:"<p>for the reverb to fade</p>",name:"seconds"}],examples:['s("bd sd").room(0.5).rlp(10000).rfade(0.5)','s("bd sd").room(0.5).rlp(5000).rfade(4)'],longname:"roomfade",kind:"member",scope:"global"},{comment:`/**
   ...
   *
   */`,meta:{filename:"controls.mjs",lineno:1042,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{}},description:`<p>Sets the room size of the reverb, see {@link room}.
When this property is changed, the reverb will be recaculated, so only change this sparsely..</p>`,name:"roomsize",params:[{type:{names:["number","Pattern"]},description:"<p>between 0 and 10</p>",name:"size"}],tags:[{originalTitle:"synonyms",title:"synonyms",text:"rsize, sz, size",value:"rsize, sz, size"}],examples:['s("bd sd").room(.8).rsize(1)','s("bd sd").room(.8).rsize(4)'],longname:"roomsize",kind:"member",scope:"global"},{comment:`/**
   ...
   *
   */`,meta:{filename:"controls.mjs",lineno:1073,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{}},description:`<p>Dynamics Compressor. The params are <code>compressor(&quot;threshold:ratio:knee:attack:release&quot;)</code>
...
.compressor("-20:20:10:.002:.02")`],longname:"compressor",kind:"member",scope:"global"},{comment:`/**
   ...
   * @superdirtOnly
   *
   */`,meta:{filename:"controls.mjs",lineno:1111,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{}},description:`<p>Made by Calum Gunn. Reminiscent of some weird mixture of filter, ring-modulator and pitch-shifter. The SuperCollider manual defines Squiz as:</p>
<p>&quot;A simplistic pitch-raising algorithm. It's not meant to sound natural; its sound is reminiscent of some weird mixture of filter, ring-modulator and pitch-shifter, depending on the input. The algorithm works by cutting the signal into fragments (delimited by upwards-going zero-crossings) and squeezing those fragments in the time domain (i.e. simply playing them back faster than they came in), leaving silences inbetween. All the parameters apart from memlen can be modulated.&quot;</p>`,name:"squiz",params:[{type:{names:["number","Pattern"]},description:"<p>Try passing multiples of 2 to it - 2, 4, 8 etc.</p>",name:"squiz"}],examples:['squiz("2 4/2 6 [8 16]").s("bd").osc()'],tags:[{originalTitle:"superdirtOnly",title:"superdirtonly",text:""}],longname:"squiz",kind:"member",scope:"global"},{comment:`/**
   ...
   * .vowel("<a e i <o u>>")
   *
   */`,meta:{filename:"controls.mjs",lineno:1132,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{}},description:"<p>Formant filter to make things sound like vowels.</p>",name:"vowel",params:[{type:{names:["string","Pattern"]},description:"<p>You can use a e i o u.</p>",name:"vowel"}],examples:[`note("c2 <eb2 <g2 g1>>").s('sawtooth')
.vowel("<a e i <o u>>")`],longname:"vowel",kind:"member",scope:"global"},{comment:`/**
   ...
   *
   */`,meta:{filename:"controls.mjs",lineno:1222,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{}},description:`<p>Multiplies the duration with the given number. Also cuts samples off at the end if they exceed the duration.
 ...
 */`,meta:{range:[5141,5293],filename:"euclid.mjs",lineno:127,columnno:6,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100005637",name:"_euclidRot",type:"FunctionExpression"},vars:{b:"_euclidRot~b"}},examples:[`// A thirteenth century Persian rhythm called Khafif-e-ramal.
...
so there will be no gaps.</p>`,name:"euclidLegato",memberof:"Pattern",examples:['n("g2").decay(.1).sustain(.3).euclidLegato(3,8)'],scope:"static",longname:"Pattern.euclidLegato",kind:"member"},{comment:"/** @class Class representing a pattern. */",meta:{range:[1532,25380],filename:"pattern.mjs",lineno:25,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100007569",name:"exports.Pattern",type:"ClassDeclaration"}},name:"Pattern",longname:"Pattern",kind:"class",classdesc:"<p>Class representing a pattern.</p>",scope:"global",description:"<p>Create a pattern. As an end user, you will most likely not create a Pattern directly.</p>",tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],memberof:"Pattern",params:[{type:{names:["function"]},description:"<p>The function that maps a {@link State} to an array of {@link Hap}.</p>",name:"query"}]},{comment:`/**
   ...
   */`,meta:{range:[2398,2507],filename:"pattern.mjs",lineno:49,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100007590",name:"Pattern#withValue",type:"MethodDefinition",paramnames:["func"]},vars:{"":null}},description:`<p>Returns a new pattern, with the function applied to the value of
each hap. It has the alias {@link Pattern#fmap}.</p>`,tags:[{originalTitle:"synonyms",title:"synonyms",text:"fmap",value:"fmap"}],params:[{type:{names:["function"]},description:"<p>to to apply to the value</p>",name:"func"}],returns:[{description:"<p>Pattern</p>"}],examples:['"0 1 2".withValue(v => v + 10).log()'],name:"withValue",longname:"Pattern#withValue",kind:"function",memberof:"Pattern",scope:"instance"},{comment:`/**
   ...
   * @noAutocomplete
   * @returns Pattern
   */`,meta:{range:[2910,3652],filename:"pattern.mjs",lineno:70,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100007626",name:"Pattern#appWhole",type:"MethodDefinition",paramnames:["whole_func","pat_val"]},vars:{"":null}},description:`<p>Assumes 'this' is a pattern of functions, and given a function to
resolve wholes, applies a given pattern of values to that
pattern of functions.</p>`,params:[{type:{names:["function"]},name:"whole_func"},{type:{names:["function"]},name:"func"}],tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],returns:[{description:"<p>Pattern</p>"}],name:"appWhole",longname:"Pattern#appWhole",kind:"function",memberof:"Pattern",scope:"instance"},{comment:`/**
   ...
   * @noAutocomplete
   * @returns Pattern
   */`,meta:{range:[4203,4483],filename:"pattern.mjs",lineno:106,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100007733",name:"Pattern#appBoth",type:"MethodDefinition",paramnames:["pat_val"]},vars:{"":null}},description:`<p>When this method is called on a pattern of functions, it matches its haps
with those in the given pattern of values.  A new pattern is returned, with
...
intersection. This applies to both the part and the whole timespan.</p>`,params:[{type:{names:["Pattern"]},name:"pat_val"}],tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],returns:[{description:"<p>Pattern</p>"}],name:"appBoth",longname:"Pattern#appBoth",kind:"function",memberof:"Pattern",scope:"instance"},{comment:`/**
   ...
   * @noAutocomplete
   * @returns Pattern
   */`,meta:{range:[4927,5671],filename:"pattern.mjs",lineno:127,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100007769",name:"Pattern#appLeft",type:"MethodDefinition",paramnames:["pat_val"]},vars:{"":null}},description:`<p>As with {@link Pattern#appBoth}, but the <code>whole</code> timespan is not the intersection,
but the timespan from the function of patterns that this method is called
on. In practice, this means that the pattern structure, including onsets,
are preserved from the pattern of functions (often referred to as the left
hand or inner pattern).</p>`,params:[{type:{names:["Pattern"]},name:"pat_val"}],tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],returns:[{description:"<p>Pattern</p>"}],name:"appLeft",longname:"Pattern#appLeft",kind:"function",memberof:"Pattern",scope:"instance"},{comment:`/**
   ...
   * @noAutocomplete
   * @returns Pattern
   */`,meta:{range:[5939,6684],filename:"pattern.mjs",lineno:158,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100007879",name:"Pattern#appRight",type:"MethodDefinition",paramnames:["pat_val"]},vars:{"":null}},description:`<p>As with {@link Pattern#appLeft}, but <code>whole</code> timespans are instead taken from the
pattern of values, i.e. structure is preserved from the right hand/outer
...
silence`],tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],name:"queryArc",longname:"Pattern#queryArc",kind:"function",memberof:"Pattern",scope:"instance"},{comment:`/**
   ...
   * @returns Pattern
   * @noAutocomplete
   */`,meta:{range:[12545,12745],filename:"pattern.mjs",lineno:359,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100008529",name:"Pattern#splitQueries",type:"MethodDefinition",paramnames:[]},vars:{"":null}},description:`<p>Returns a new pattern, with queries split at cycle boundaries. This makes
some calculations easier to express, as all haps are then constrained to
happen within a cycle.</p>`,returns:[{description:"<p>Pattern</p>"}],tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],name:"splitQueries",longname:"Pattern#splitQueries",kind:"function",memberof:"Pattern",scope:"instance",params:[]},{comment:`/**
   ...
   * @returns Pattern
   * @noAutocomplete
   */`,meta:{range:[12988,13082],filename:"pattern.mjs",lineno:374,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100008569",name:"Pattern#withQuerySpan",type:"MethodDefinition",paramnames:["func"]},vars:{"":null}},description:`<p>Returns a new pattern, where the given function is applied to the query
timespan before passing it to the original pattern.</p>`,params:[{type:{names:["function"]},description:"<p>the function to apply</p>",name:"func"}],returns:[{description:"<p>Pattern</p>"}],tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],name:"withQuerySpan",longname:"Pattern#withQuerySpan",kind:"function",memberof:"Pattern",scope:"instance"},{comment:`/**
   ...
   * @returns Pattern
   * @noAutocomplete
   */`,meta:{range:[13556,13675],filename:"pattern.mjs",lineno:396,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100008625",name:"Pattern#withQueryTime",type:"MethodDefinition",paramnames:["func"]},vars:{"":null}},description:`<p>As with {@link Pattern#withQuerySpan}, but the function is applied to both the
begin and end time of the query timespan.</p>`,params:[{type:{names:["function"]},description:"<p>the function to apply</p>",name:"func"}],returns:[{description:"<p>Pattern</p>"}],tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],name:"withQueryTime",longname:"Pattern#withQueryTime",kind:"function",memberof:"Pattern",scope:"instance"},{comment:`/**
   ...
   * @returns Pattern
   * @noAutocomplete
   */`,meta:{range:[13967,14077],filename:"pattern.mjs",lineno:408,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100008650",name:"Pattern#withHapSpan",type:"MethodDefinition",paramnames:["func"]},vars:{"":null}},description:`<p>Similar to {@link Pattern#withQuerySpan}, but the function is applied to the timespans
...
begin and end time of the hap timespans.</p>`,params:[{type:{names:["function"]},description:"<p>the function to apply</p>",name:"func"}],returns:[{description:"<p>Pattern</p>"}],tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],name:"withHapTime",longname:"Pattern#withHapTime",kind:"function",memberof:"Pattern",scope:"instance"},{comment:`/**
   ...
   * @returns Pattern
   * @noAutocomplete
   */`,meta:{range:[15925,16165],filename:"pattern.mjs",lineno:480,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100008780",name:"Pattern#withLoc",type:"MethodDefinition",paramnames:["start","end"]},vars:{"":null}},description:`<p>Returns a new pattern with the given location information added to the
...
inside haps.</p>`,params:[{type:{names:["function"]},name:"value_test"}],returns:[{description:"<p>Pattern</p>"}],tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],name:"filterValues",longname:"Pattern#filterValues",kind:"function",memberof:"Pattern",scope:"instance"},{comment:`/**
   ...
   * @returns Pattern
   * @noAutocomplete
   */`,meta:{range:[16975,17056],filename:"pattern.mjs",lineno:518,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100008865",name:"Pattern#removeUndefineds",type:"MethodDefinition",paramnames:[]},vars:{"":null}},description:`<p>Returns a new pattern, with haps containing undefined values removed from
query results.</p>`,returns:[{description:"<p>Pattern</p>"}],tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],name:"removeUndefineds",longname:"Pattern#removeUndefineds",kind:"function",memberof:"Pattern",scope:"instance",params:[]},{comment:`/**
   ...
   * @returns Pattern
   * @noAutocomplete
   */`,meta:{range:[17300,17565],filename:"pattern.mjs",lineno:529,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100008879",name:"Pattern#onsetsOnly",type:"MethodDefinition",paramnames:[]},vars:{"":null}},description:`<p>Returns a new pattern, with all haps without onsets filtered out. A hap
...
as its <code>part</code> timespan.</p>`,returns:[{description:"<p>Pattern</p>"}],tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],name:"onsetsOnly",longname:"Pattern#onsetsOnly",kind:"function",memberof:"Pattern",scope:"instance",params:[]},{comment:`/**
   ...
   * @returns Pattern
   * @noAutocomplete
   */`,meta:{range:[17742,17876],filename:"pattern.mjs",lineno:542,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100008894",name:"Pattern#discreteOnly",type:"MethodDefinition",paramnames:[]},vars:{"":null}},description:`<p>Returns a new pattern, with 'continuous' haps (those without 'whole'
timespans) removed from query results.</p>`,returns:[{description:"<p>Pattern</p>"}],tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],name:"discreteOnly",longname:"Pattern#discreteOnly",kind:"function",memberof:"Pattern",scope:"instance",params:[]},{comment:`/**
   ...
   * @noAutocomplete
   */`,meta:{range:[18010,19455],filename:"pattern.mjs",lineno:552,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100008908",name:"Pattern#defragmentHaps",type:"MethodDefinition",paramnames:[]},vars:{"":null}},description:`<p>Combines adjacent haps with the same value and whole.  Only
 ...
 * .arpWith(haps => haps[2])
 * */`,meta:{range:[26350,26560],filename:"pattern.mjs",lineno:850,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100009852",name:"Pattern.prototype.arpWith",type:"FunctionExpression",paramnames:["func"]},vars:{"":null}},description:"<p>Selects indices in in stacked notes.</p>",examples:[`note("<[c,eb,g]!2 [c,f,ab] [d,f,ab]>")
 ...
 * */`,meta:{range:[26702,26817],filename:"pattern.mjs",lineno:863,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100009905",name:"Pattern.prototype.arp",type:"FunctionExpression",paramnames:["pat"]},vars:{"":null}},description:"<p>Selects indices in in stacked notes.</p>",examples:[`note("<[c,eb,g]!2 [c,f,ab] [d,f,ab]>")
...
// See add for more information.`],scope:"static",longname:"Pattern.sub",kind:"member"},{comment:`/**
   ...
   *   .struct("x ~ x ~ ~ x ~ x ~ ~ ~ x ~ x ~ ~")
   *   .slow(4)
   */`,meta:{range:[32715,32803],filename:"pattern.mjs",lineno:1056,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100010431",name:"Pattern.prototype.struct",type:"FunctionExpression",paramnames:["args"]}},description:"<p>Applies the given structure to the pattern:</p>",examples:[`note("c3,eb3,g3")
  .struct("x ~ x ~ ~ x ~ x ~ ~ ~ x ~ x ~ ~")
   ...
   */`,meta:{range:[33031,33116],filename:"pattern.mjs",lineno:1068,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100010471",name:"Pattern.prototype.mask",type:"FunctionExpression",paramnames:["args"]}},description:"<p>Returns silence when mask is 0 or &quot;~&quot;</p>",examples:['note("c [eb,g] d [eb,g]").mask("<1 [0 1]>").slow(2)'],name:"mask",longname:"Pattern#mask",kind:"function",memberof:"Pattern",scope:"instance"},{comment:`/**
   * Resets the pattern to the start of the cycle for each onset of the reset pattern.
   *
   * @example
   * s("<bd lt> sd, hh*4").reset("<x@3 x(3,8)>")
   */`,meta:{range:[33377,33465],filename:"pattern.mjs",lineno:1080,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100010511",name:"Pattern.prototype.reset",type:"FunctionExpression",paramnames:["args"]}},description:"<p>Resets the pattern to the start of the cycle for each onset of the reset pattern.</p>",examples:['s("<bd lt> sd, hh*4").reset("<x@3 x(3,8)>")'],name:"reset",longname:"Pattern#reset",kind:"function",memberof:"Pattern",scope:"instance"},{comment:`/**
   * Restarts the pattern for each onset of the restart pattern.
   * While reset will only reset the current cycle, restart will start from cycle 0.
   *
   * @example
   * s("<bd lt> sd, hh*4").restart("<x@3 x(3,8)>")
   */`,meta:{range:[33794,33888],filename:"pattern.mjs",lineno:1093,columnno:2,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100010551",name:"Pattern.prototype.restart",type:"FunctionExpression",paramnames:["args"]}},description:`<p>Restarts the pattern for each onset of the restart pattern.
 ...
 * slowcat(e5, b4, [d5, c5])
 *
 */`,meta:{range:[36642,37553],filename:"pattern.mjs",lineno:1199,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100010774",name:"exports.slowcat",type:"FunctionDeclaration",paramnames:["pats"]}},description:`<p>Concatenation: combines a list of patterns, switching between them successively, one per cycle:</p>
 ...
 * @returns Pattern
 * @noAutocomplete
 */`,meta:{range:[46689,46793],filename:"pattern.mjs",lineno:1505,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100012112",name:"exports.toBipolar",type:"VariableDeclaration"}},description:`<p>Assumes a numerical pattern, containing unipolar values in the range 0 ..</p>
<ol>
 ...
 * @returns Pattern
 * @noAutocomplete
 */`,meta:{range:[46994,47104],filename:"pattern.mjs",lineno:1515,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100012134",name:"exports.fromBipolar",type:"VariableDeclaration"}},description:`<p>Assumes a numerical pattern, containing bipolar values in the range -1 .. 1
 ...
 *   s("~ bd sd ~")
 * )
 */`,meta:{range:[49101,49354],filename:"pattern.mjs",lineno:1588,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100012279",name:"exports.compress",type:"VariableDeclaration"}},description:"<p>Compress each cycle into the given timespan, leaving a gap</p>",examples:[`cat(
  s("bd sd").compress(.25,.75),
  s("~ bd sd ~")
 ...
 */`,meta:{range:[51243,51412],filename:"pattern.mjs",lineno:1643,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100012621",name:"exports.focus",type:"VariableDeclaration"}},description:"<p>Similar to compress, but doesn't leave gaps, and the 'focus' can be bigger than a cycle</p>",examples:['s("bd hh sd hh").focus(1/4, 3/4)'],name:"focus",longname:"focus",kind:"constant",scope:"global"},{comment:`/** The ply function repeats each event the given number of times.
 * @example
 * s("bd ~ sd cp").ply("<1 2 3>")
 */`,meta:{range:[51679,51805],filename:"pattern.mjs",lineno:1657,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100012696",name:"exports.ply",type:"VariableDeclaration"}},description:"<p>The ply function repeats each event the given number of times.</p>",examples:['s("bd ~ sd cp").ply("<1 2 3>")'],name:"ply",longname:"ply",kind:"constant",scope:"global"},{comment:`/**
 ...
 */`,meta:{range:[53305,53422],filename:"pattern.mjs",lineno:1714,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100012841",name:"exports.inside",type:"VariableDeclaration"}},description:"<p>Carries out an operation 'inside' a cycle.</p>",examples:[`"0 1 2 3 4 3 2 1".inside(4, rev).scale('C major').note()
 ...
 */`,meta:{range:[53626,53745],filename:"pattern.mjs",lineno:1724,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100012865",name:"exports.outside",type:"VariableDeclaration"}},description:"<p>Carries out an operation 'outside' a cycle.</p>",examples:[`"<[0 1] 2 [3 4] 5>".outside(4, rev).scale('C major').note()
 ...
 */`,meta:{range:[55336,55426],filename:"pattern.mjs",lineno:1789,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100012984",name:"exports.cpm",type:"VariableDeclaration"}},description:"<p>Plays the pattern at the given cycles per minute.</p>",examples:['s("<bd sd>,hh*2").cpm(90) // = 90 bpm'],name:"cpm",longname:"cpm",kind:"constant",scope:"global"},{comment:`/**
 ...
 */`,meta:{range:[56554,56847],filename:"pattern.mjs",lineno:1830,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100013071",name:"exports.zoom",type:"VariableDeclaration"}},description:"<p>Plays a portion of a pattern, specified by the beginning and end of a time span. The new resulting pattern is played over the time period of the original pattern:</p>",examples:[`s("bd*2 hh*3 [sd bd]*2 perc").zoom(0.25, 0.75)
 ...
 * breakbeat feel.
 * @returns Pattern
 */`,meta:{range:[59044,59182],filename:"pattern.mjs",lineno:1915,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100013315",name:"exports.brak",type:"VariableDeclaration"}},description:`<p>Returns a new pattern where every other cycle is played once, twice as
fast, and offset in time by one quarter of a cycle. Creates a kind of
 ...
 *      ).slow(2)
 */`,meta:{range:[60336,60466],filename:"pattern.mjs",lineno:1955,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100013463",name:"exports.pressBy",type:"VariableDeclaration"}},description:`<p>Like press, but allows you to specify the amount by which each
event is shifted. pressBy(0.5) is the same as press, while
 ...
 *      ).slow(2)
 */`,meta:{range:[60642,60729],filename:"pattern.mjs",lineno:1966,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100013492",name:"exports.press",type:"VariableDeclaration"}},description:"<p>Syncopates a rhythm, by shifting each event halfway into its timespan.</p>",examples:[`stack(s("hh*4"),
      s("bd mt sd ht").every(4, press)
 ...
 *   s("hh*3")
 * )
 */`,meta:{range:[60825,60900],filename:"pattern.mjs",lineno:1978,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100013508",name:"exports.hush",type:"VariableDeclaration"}},description:"<p>Silences a pattern.</p>",examples:[`stack(
  s("bd").hush(),
  s("hh*3")
 ...
 */`,meta:{range:[61977,62073],filename:"pattern.mjs",lineno:2017,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100013633",name:"exports.jux",type:"VariableDeclaration"}},description:"<p>The jux function creates strange stereo effects, by applying a function to a pattern, but only in the right-hand channel.</p>",examples:['s("lt ht mt ht hh").jux(rev)'],name:"jux",longname:"jux",kind:"constant",scope:"global"},{comment:`/**
 ...
 */`,meta:{range:[66335,66450],filename:"pattern.mjs",lineno:2149,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100013984",name:"exports.ribbon",type:"VariableDeclaration"}},description:"<p>Loops the pattern inside at <code>offset</code> for <code>cycles</code>.</p>",params:[{type:{names:["number"]},description:"<p>start point of loop in cycles</p>",name:"offset"},{type:{names:["number"]},description:"<p>loop length in cycles</p>",name:"cycles"}],examples:[`// Looping a portion of randomness
 ...
 */`,meta:{range:[66827,66981],filename:"pattern.mjs",lineno:2161,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100014040",name:"exports.",type:"VariableDeclaration"}},description:"<p>Sets the color of the hap in visualizations like pianoroll or highlighting.</p>",name:"",longname:"",kind:"constant",scope:"global"},{comment:`/**
 *
...
s("rhodes").loopAtCps(4,1.5).cps(1.5)`],scope:"static",longname:"Pattern.loopAtCps",kind:"member"},{comment:"/** exposes a custom value at query time. basically allows mutating state without evaluation */",meta:{range:[72865,72965],filename:"pattern.mjs",lineno:2348,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100014541",name:"exports.ref",type:"VariableDeclaration"}},description:"<p>exposes a custom value at query time. basically allows mutating state without evaluation</p>",name:"ref",longname:"ref",kind:"constant",scope:"global"},{comment:`/**
 ...
 *
 */`,meta:{range:[1579,1619],filename:"signal.mjs",lineno:35,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100016256",name:"exports.saw",type:"VariableDeclaration"}},description:"<p>A sawtooth signal between 0 and 1.</p>",returns:[{type:{names:["Pattern"]}}],examples:['"c3 [eb3,g3] g2 [g3,bb3]".note().clip(saw.slow(4))',"saw.range(0,8).segment(8).scale('C major').slow(4).note()"],name:"saw",longname:"saw",kind:"constant",scope:"global"},{comment:`/**
 ...
 *
 */`,meta:{range:[1868,1908],filename:"signal.mjs",lineno:48,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100016294",name:"exports.sine",type:"VariableDeclaration"}},description:"<p>A sine signal between 0 and 1.</p>",returns:[{type:{names:["Pattern"]}}],examples:["sine.segment(16).range(0,15).slow(2).scale('C minor').note()"],name:"sine",longname:"sine",kind:"constant",scope:"global"},{comment:`/**
 ...
 *
 */`,meta:{range:[2072,2126],filename:"signal.mjs",lineno:58,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100016302",name:"exports.cosine",type:"VariableDeclaration"}},description:"<p>A cosine signal between 0 and 1.</p>",returns:[{type:{names:["Pattern"]}}],examples:["stack(sine,cosine).segment(16).range(0,15).slow(2).scale('C minor').note()"],name:"cosine",longname:"cosine",kind:"constant",scope:"global"},{comment:`/**
 ...
 *
 */`,meta:{range:[2325,2386],filename:"signal.mjs",lineno:69,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100016332",name:"exports.square",type:"VariableDeclaration"}},description:"<p>A square signal between 0 and 1.</p>",returns:[{type:{names:["Pattern"]}}],examples:["square.segment(2).range(0,7).scale('C minor').note()"],name:"square",longname:"square",kind:"constant",scope:"global"},{comment:`/**
 ...
 *
 */`,meta:{range:[2570,2608],filename:"signal.mjs",lineno:80,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100016357",name:"exports.tri",type:"VariableDeclaration"}},description:"<p>A triangle signal between 0 and 1.</p>",returns:[{type:{names:["Pattern"]}}],examples:["tri.segment(8).range(0,7).scale('C minor').note()"],name:"tri",longname:"tri",kind:"constant",scope:"global"},{comment:`/**
 * A discrete pattern of numbers from 0 to n-1
 * @example
 * run(4).scale('C4 major').note()
 * // "0 1 2 3".scale('C4 major').note()
 */`,meta:{range:[3563,3624],filename:"signal.mjs",lineno:123,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100016512",name:"exports.run",type:"VariableDeclaration"}},description:"<p>A discrete pattern of numbers from 0 to n-1</p>",examples:[`run(4).scale('C4 major').note()
 ...
 */`,meta:{range:[3915,3953],filename:"signal.mjs",lineno:138,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100016538",name:"exports.rand2",type:"VariableDeclaration"}},description:"<p>A continuous pattern of random numbers, between -1 and 1</p>",name:"rand2",longname:"rand2",kind:"constant",scope:"global"},{comment:`/**
 ...
 * @param {*} xs
 * @returns {Pattern}
 */`,meta:{range:[4900,4987],filename:"signal.mjs",lineno:172,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100016665",name:"exports.chooseWith",type:"VariableDeclaration"}},description:`<p>Choose from the list of values (or patterns of values) using the given
 ...
 * @param {*} xs
 * @returns {Pattern}
 */`,meta:{range:[5189,5278],filename:"signal.mjs",lineno:183,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100016681",name:"exports.chooseInWith",type:"VariableDeclaration"}},description:`<p>As with {chooseWith}, but the structure comes from the chosen values, rather
 ...
 */`,meta:{range:[5444,5498],filename:"signal.mjs",lineno:192,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100016697",name:"exports.choose",type:"VariableDeclaration"}},description:"<p>Chooses randomly from the given list of elements.</p>",params:[{type:{names:["any"]},variable:!0,description:"<p>values / patterns to choose from.</p>",name:"xs"}],returns:[{type:{names:["Pattern"]},description:`<ul>
 ...
 * @param  {...any} xs
 * @returns {Pattern}
 */`,meta:{range:[5723,5801],filename:"signal.mjs",lineno:201,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100016709",name:"Pattern.prototype.choose",type:"FunctionExpression",paramnames:["xs"]}},description:`<p>Chooses from the given list of values (or patterns of values), according
to the pattern that the method is called on. The pattern should be in
 ...
 * @param  {...any} xs
 * @returns {Pattern}
 */`,meta:{range:[5956,6049],filename:"signal.mjs",lineno:211,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100016725",name:"Pattern.prototype.choose2",type:"FunctionExpression",paramnames:["xs"]}},description:`<p>As with choose, but the pattern that this method is called on should be
 ...
 * @example
 * "bd | hh | sd".s().fast(4)
 */`,meta:{range:[6233,6306],filename:"signal.mjs",lineno:223,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100016743",name:"exports.chooseCycles",type:"VariableDeclaration"}},description:"<p>Picks one of the elements at random each cycle.</p>",returns:[{type:{names:["Pattern"]}}],examples:['chooseCycles("bd", "hh", "sd").s().fast(4)','"bd | hh | sd".s().fast(4)'],name:"chooseCycles",longname:"chooseCycles",kind:"constant",scope:"global"},{comment:`/**
 ...
 * @noAutocomplete
 */`,meta:{range:[2576,2743],filename:"util.mjs",lineno:66,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100027621",name:"exports.getFreq",type:"VariableDeclaration"}},deprecated:"does not appear to be referenced or invoked anywhere in the codebase",tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],name:"getFreq",longname:"getFreq",kind:"constant",scope:"global"},{comment:`/**
 * @deprecated only used in workshop (first-notes)
 * @noAutocomplete
 */`,meta:{range:[2902,3021],filename:"util.mjs",lineno:78,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/core",code:{id:"astnode100027660",name:"exports.midi2note",type:"VariableDeclaration"}},deprecated:"only used in workshop (first-notes)",tags:[{originalTitle:"noAutocomplete",title:"noautocomplete",text:""}],name:"midi2note",longname:"midi2note",kind:"constant",scope:"global"},{comment:`/**
 ...
 */`,meta:{range:[4583,5898],filename:"index.mjs",lineno:137,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/csound",code:{id:"astnode100029538",name:"exports.csoundm",type:"VariableDeclaration"}},description:`<p>Sends notes to Csound for rendering with MIDI semantics. The hap value is
...
For more info, read <a href="https://strudel.tidalcycles.org/learn/input-output">MIDI &amp; OSC in the docs</a></p>`,name:"osc",memberof:"Pattern",returns:[{description:"<p>Pattern</p>"}],scope:"static",longname:"Pattern.osc",kind:"member"},{comment:`/** Generates a reverb impulse response.
...
immediately within the current execution context, or later.</p>`,name:"callback"}],name:"applyGradualLowpass",longname:"applyGradualLowpass",kind:"function",scope:"global"},{comment:`/** @private
 ...
 @return {!Array.<!Float32Array>} An array containing the Float32Array of each channel's samples. */`,meta:{range:[4508,4691],filename:"reverbGen.mjs",lineno:116,columnno:4,path:"/Users/michaelgogins/cloud-5/strudel/packages/superdough",code:{id:"astnode100054372",name:"getAllChannelData",type:"FunctionExpression"},vars:{channels:"getAllChannelData~channels",i:"getAllChannelData~i","channels[undefined]":"getAllChannelData~channels.undefined]"}},access:"private",params:[{type:{names:["AudioBuffer"]},nullable:!1,name:"buffer"}],returns:[{type:{names:["Array.<!Float32Array>"]},nullable:!1,description:"<p>An array containing the Float32Array of each channel's samples.</p>"}],name:"getAllChannelData",longname:"getAllChannelData",kind:"function",scope:"global"},{comment:`/** @private
 @return {number} A random number from -1 to 1. */`,meta:{range:[4762,4824],filename:"reverbGen.mjs",lineno:126,columnno:4,path:"/Users/michaelgogins/cloud-5/strudel/packages/superdough",code:{id:"astnode100054407",name:"randomSample",type:"FunctionExpression"}},access:"private",returns:[{type:{names:["number"]},description:"<p>A random number from -1 to 1.</p>"}],name:"randomSample",longname:"randomSample",kind:"function",scope:"global",params:[]},{comment:`/**
 ...
 * s("[bd ~]*2, [~ hh]*2, ~ sd")
 *
 */`,meta:{range:[5090,6479],filename:"sampler.mjs",lineno:153,columnno:0,path:"/Users/michaelgogins/cloud-5/strudel/packages/superdough",code:{id:"astnode100055127",name:"exports.samples",type:"VariableDeclaration"}},description:"<p>Loads a collection of samples to use with <code>s</code></p>",examples:[`samples('github:tidalcycles/Dirt-Samples/master');
