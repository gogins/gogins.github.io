 ...
 * s("[bd ~]*2, [~ hh]*2, ~ sd")
 *
 */`,meta:{range:[5036,6425],filename:"sampler.mjs",lineno:151,columnno:0,path:"/Users/michaelgogins/cloud-music/strudel/packages/webaudio",code:{id:"astnode100055164",name:"exports.samples",type:"VariableDeclaration"}},description:"<p>Loads a collection of samples to use with <code>s</code></p>",examples:[`samples('github:tidalcycles/Dirt-Samples/master');
