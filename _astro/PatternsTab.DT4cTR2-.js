import{j as e}from"./jsx-runtime.7_bh7l-E.js";import{u as C,$ as v,c as w,d as f,g as D,e as k,f as B,p as x,h as G,j as E,s as j,k as p,m as r,n as S,o as N}from"./util.DLPoamJT.js";import{r as u}from"./index.CPLOniuq.js";const _=`// Koji Kondo - Swimming (Super Mario World)
stack(
  seq(
    "~",
    "~",
...
.pianoroll({fold:1})`,T=`// Koji Kondo - Princess Zelda's Rescue
stack(
  // melody
...
.pianoroll({fold:1})
`,Y=`// adapted from a Barry Harris excercise
"0,2,[7 6]"
  .add("<0 1 2 3 4 5 7 8>")
  .scale('C bebop major')
  .transpose("<0 1 2 1>/8")
...
//.pianoroll({fold:1})`,O=`// "Wavy kalimba"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
.clip(.5)
.piano()
.pianoroll()`,$=`// Hirokazu Tanaka - World 1-1
stack(
  // melody
  note(\`<
...
n("[-7*3],0,2,6,[8 7]")
  ...
  .slow(2).piano()
//.pianoroll({maxMidi:160})`,I=`// "Melting submarine"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
stack(
    ...
    .delayfeedback(.7)
    .orbit(2)
  ).sometimes(x=>x.speed("-1"))`,ee=`// "Belldub"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
).reset("<x@7 x(5,8,-1)>")`,le=`// "Jux und tollerei"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
.note()
//.pianoroll()
.csound('CoolSynth')`,ie=`// "Lounge sponge"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
...
`,de=Object.freeze(Object.defineProperty({__proto__:null,amensister:ne,arpoon:re,barryHarris:Y,bassFuge:V,belldub:ee,blippyRhodes:q,caverave:P,chop:Z,csoundDemo:ce,delay:Q,dinofunk:se,echoPiano:W,festivalOfFingers:K,festivalOfFingers3:U,flatrave:te,giantSteps:R,goodTimes:H,holyflute:oe,juxUndTollerei:le,loungeSponge:ie,meltingsubmarine:I,orbit:X,randomBells:z,sampleDemo:ae,sampleDrums:M,sml1:$,swimming:_,undergroundPlumber:L,waa2:J,wavyKalimba:O,zeldasRescue:T},Symbol.toStringTag,{value:"Module"}));Object.fromEntries(Object.entries(de).map(([s,t],a)=>[a,{id:a,code:t,collection:"Stock Examples"}]));const be=()=>{const s=C(v),t=C(w),a=u.useMemo(()=>{const c=new Map;return c.set(f.featured,s),c.set(f.public,t),c},[s,t]);return{patterns:u.useMemo(()=>Object.assign({},...a.values()),[a]),collections:a}};function me(...s){return s.filter(Boolean).join(" ")}function pe({value:s,onChange:t,items:a}){return e.jsx("div",{className:"flex max-w-lg",children:Object.entries(a).map(([n,c],i,h)=>e.jsx("button",{id:n,onClick:()=>t(n),className:me("px-2 border-b h-8 whitespace-nowrap",s===n?"border-foreground":"border-transparent"),children:c.toLowerCase()},n))})}function he(...s){return s.filter(Boolean).join(" ")}function ue({pattern:s}){const t=u.useMemo(()=>D(s.code),[s]);let a=t.title;if(a==null){const n=new Date(s.created_at);isNaN(n)||(a=n.toLocaleDateString())}return a==null&&(a=s.hash),a==null&&(a="unnamed"),e.jsx(e.Fragment,{children:`${s.id}: ${a} by ${Array.isArray(t.by)?t.by.join(","):"Anonymous"}`})}function Fe({showOutline:s,onClick:t,pattern:a,showHiglight:n}){return e.jsx("a",{className:he("mr-4 hover:opacity-50 cursor-pointer block",s&&"outline outline-1",n&&"bg-selection"),onClick:t,children:e.jsx(ue,{pattern:a})})}function y({patterns:s,activePattern:t,onClick:a,started:n}){const c=B(),h=x(c).id;return e.jsx("div",{className:"font-mono text-sm",children:Object.values(s).reverse().map(d=>{const l=d.id;return e.jsx(Fe,{pattern:d,showHiglight:l===h,showOutline:l===t&&n,onClick:()=>a(l)},l)})})}function b({children:s,onClick:t,label:a,labelIsHidden:n}){return e.jsxs("button",{className:"hover:opacity-50 text-nowrap",onClick:t,title:a,children:[n!==!0&&a,s]})}function ye({context:s}){const t=k(),a=B(),n=x(a),{userPatterns:c,patternFilter:i}=G(),d=be().collections,l=(o,m=!1)=>{s.handleUpdate(o,m)},F=n?.id,g=!E();return e.jsxs("div",{className:"px-4 w-full dark:text-white text-stone-900 space-y-2  flex flex-col overflow-hidden max-h-full h-full",children:[e.jsx(pe,{value:i,onChange:o=>j.setKey("patternFilter",o),items:p}),i===p.user&&e.jsx("div",{children:e.jsxs("div",{className:"pr-4 space-x-4 border-b border-foreground flex max-w-full overflow-x-auto",children:[e.jsx(b,{label:"new",onClick:()=>{const{data:o}=r.createAndAddToDB();l(o)}}),e.jsx(b,{label:"duplicate",onClick:()=>{const{data:o}=r.duplicate(n);l(o)}}),e.jsx(b,{label:"delete",onClick:()=>{const{data:o}=r.delete(F);l({...o,collection:r.collection})}}),e.jsxs("label",{className:"hover:opacity-50 cursor-pointer",children:[e.jsx("input",{style:{display:"none"},type:"file",multiple:!0,accept:"text/plain,application/json",onChange:o=>S(o.target.files)}),"import"]}),e.jsx(b,{label:"export",onClick:N}),e.jsx(b,{label:"delete-all",onClick:()=>{const{data:o}=r.clearAll();l(o)}})]})}),e.jsxs("section",{className:"flex overflow-y-auto max-h-full flex-grow flex-col",children:[i===p.user&&e.jsx(y,{onClick:o=>l({...c[o],collection:r.collection},g),patterns:c,started:s.started,activePattern:t,viewingPatternID:F}),i!==p.user&&Array.from(d.keys()).map(o=>{const m=d.get(o);return e.jsxs("section",{className:"py-2",children:[e.jsx("h2",{className:"text-xl mb-2",children:o}),e.jsx("div",{className:"font-mono text-sm",children:e.jsx(y,{onClick:A=>l({...m[A],collection:o},g),started:s.started,patterns:m,activePattern:t})})]},o)})]})]})}export{pe as B,ue as P,ye as a,me as c};
//# sourceMappingURL=PatternsTab.DT4cTR2-.js.map
