import{j as e}from"./jsx-runtime.DDS51bD4.js";import{u as C,$ as v,c as w,d as f,g as D,e as k,f as B,p as x,h as G,s as E,j as p,k as r,m as j,n as S}from"./useClient.DUtyMhTB.js";import{r as u}from"./index.DIn8BZQ7.js";function N(...s){return s.filter(Boolean).join(" ")}function _({value:s,onChange:t,items:a}){return e.jsx("div",{className:"flex max-w-lg",children:Object.entries(a).map(([n,c],i,h)=>e.jsx("button",{onClick:()=>t(n),className:N("px-2 border-b h-8 whitespace-nowrap",s===n?"border-foreground":"border-transparent"),children:c.toLowerCase()},n))})}const R=`// Koji Kondo - Swimming (Super Mario World)
stack(
  seq(
    "~",
    "~",
...
//# sourceMappingURL=PatternsTab.B4UOYeVC.js.map
