import{j as a}from"./jsx-runtime.XGodtQ4D.js";import{u as F,$ as v,c as w,d as C,e as D,f as B,p as x,g as k,s as G,h as g,j as h,k as E,m as j}from"./useClient.n1XF-nkt.js";import{r as f}from"./index.Nkt9jjly.js";function _(...s){return s.filter(Boolean).join(" ")}function S({value:s,onChange:n,items:e}){return a.jsx("div",{className:"flex max-w-lg",children:Object.entries(e).map(([o,c],d,p)=>a.jsx("button",{onClick:()=>n(o),className:_("px-2 border-b h-8 whitespace-nowrap",s===o?"border-foreground":"border-transparent"),children:c.toLowerCase()},o))})}const N=["by","url","genre","license"];function R(s){const n=/\/\*([\s\S]*?)\*\/|\/\/(.*)$/gm,e=[...s.matchAll(n)].map(p=>(p[1]||p[2]||"").trim()),o={},[c,d]=(e[0]||"").split('"');c.trim()===""&&d!==void 0&&(o.title=d);for(const p of e){const m=p.split("@").slice(1);for(const l of m){let[i,r]=l.split(/ (.*)/s);if(i=i.trim(),r=(r||"").replaceAll(/ +/g," ").trim(),N.includes(i)){const t=r.split(/[,\n]/).map(b=>b.trim()).filter(b=>b!=="");o[i]=i in o?o[i].concat(t):t}else r=r.replaceAll(/\s+/g," "),o[i]=i in o?o[i]+" "+r:r}}return o}const T=`// Koji Kondo - Swimming (Super Mario World)
stack(
  seq(
    "~",
    "~",
